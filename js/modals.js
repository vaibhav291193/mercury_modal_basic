...
(function () {
    ...
    aria.Dialog = function (dialogId, dialogSize, focusAfterClosed, focusFirst) {
        ...
        this.clearDialog();
        this.dialogNode.className = `default_dialog ${dialogSize}`; // make visible
    ...
    window.closeDialog = function (closeButton) {
        ...
        document.querySelectorAll('button, [role="link"], [role="button"], [type="button"], [type="submit"], [type="reset"]').forEach(function (el) {
            el.classList.remove('by-keyboard');
        });
    }; // end closeDialog
    ...
    window.onclick = function (event) {
        if (event.target.getAttribute('class') == 'dialog-backdrop active') {
            var topDialog = aria.getCurrentDialog();
            topDialog.close();
        }
        document.querySelectorAll('button, [role="link"], [role="button"], [type="button"], [type="submit"], [type="reset"]').forEach(function (el) {
